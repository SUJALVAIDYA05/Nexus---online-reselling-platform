...
import { Upload, X, ImageIcon, MapPin, Tag, FileText, DollarSign, Layers } from 'lucide-react';
...
export default function CreateListing() {
  ...
  useEffect(() => {
    categories.list()
      .then(data => setCategoryList(data.categories || data || []))
      .catch(() => {})
  ...
  const validate = () => {
    ...
    if (images.length === 0 && imageFiles.length === 0) errs.images = 'At least one image is required';
    setErrors(errs);
    ...
    <div className="page-enter" style={styles.page}>
      <div className="container" style={styles.container}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>List your item and reach thousands of buyers</p>
        </div>
                ...
                <CardBody>
                  ...
                  {(uploading || submitting) && (
                    <div style={styles.uploadingOverlay}>
                      ...
                      <span>{uploading ? 'Uploading images...' : 'Creating listing...'}</span>
                    </div>
                  )}
                </CardBody>
              </Card>
